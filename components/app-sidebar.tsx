        ...
        {!sidebarCollapsed && projects.length > 0 && (
          <>
            ...
            {projects.map((project) => {
              const projectTaskCount = projectTaskCounts[project.name] ?? 0
              return (
                <button
                  key={project.id}
                  onClick={() => {
                  ...
                  className="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm transition-all duration-200 text-sidebar-muted hover:bg-sidebar-accent/60 hover:text-sidebar-foreground"
                >
                  <div
