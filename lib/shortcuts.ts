...
export const SHORTCUT_LIST = [
  ...
  { keys: ['Ctrl', '1'], description: '跳转到仪表板' },
  { keys: ['Ctrl', '2'], description: '跳转到任务' },
  { keys: ['Ctrl', '3'], description: '跳转到专注' },
  { keys: ['Ctrl', '4'], description: '跳转到习惯' },
  { keys: ['Ctrl', '5'], description: '跳转到目标' },
  { keys: ['Ctrl', '6'], description: '跳转到分析' },
  { keys: ['Ctrl', '7'], description: '跳转到设置' },
  ...
  { keys: ['Ctrl', 'Shift', 'F'], description: '全局（桌面端）：显示/隐藏主窗口' },
  { keys: ['Ctrl', 'Shift', 'N'], description: '全局（桌面端）：快速添加任务' },
  { keys: ['Ctrl', 'Shift', 'P'], description: '全局（桌面端）：开始/暂停番茄钟' },
]
